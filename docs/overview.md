...
| Attribute | Contents |
|-----------|----------|
| `adata.X` | Raw intensity matrix (cells × channels) |
...
| **GMM** | Per-channel Gaussian mixture models. Assignments not constrained to valid patterns; use for exploration only. | Exploring raw signal without validity constraints (bimodal regime) |
